<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteExaminee.aspx.cs" 
Inherits="ProfessorTesting.DeleteExaminee" MasterPageFile="~/Main.master" %>

<%@ Register TagPrefix="uc" TagName="MenuUser" Src="~/Controls/MenuUser.ascx" %>
<%@ Register TagPrefix="uc" TagName="DeleteExamineePanel" Src="~/Controls/DeleteExamineePanel.ascx" %>
...
<asp:Content ID="Content9" ContentPlaceHolderID="MainContent" Runat="Server">
    <uc:DeleteExamineePanel id="DeleteExamineePanel1" runat="server" />
</asp:Content>
