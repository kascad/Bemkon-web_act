...
Inherits="User_Default" Codebehind="Default.aspx.cs" %>

<%@ Register TagPrefix="uc" TagName="MenuUser" Src="~/Controls/MenuUser.ascx" %>
<%@ Register TagPrefix="uc" TagName="UserExaminees" Src="~/Controls/UserExaminees.ascx" %>
...
<asp:Content ID="ContentHorMenuModule2" ContentPlaceHolderID="HorMenuModule2" Runat="Server">
    <asp:Label ID="labelArchName" runat="server"><a href="/User/OpenArchives.aspx">Нет открытого архива</a></asp:Label>
</asp:Content>
...
<asp:Content ID="ContentHorMenuModule" ContentPlaceHolderID="HorMenuModule" Runat="Server">
    ...
    NavigateUrl="~/User/"> Обследуемые</asp:HyperLink>
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:Label ID="LabelTitle" runat="server" Visible="false" Text="" CssClass="header_block" > </asp:Label>
    <uc:UserExaminees id="userExaminees" runat="server" />
</asp:Content>
