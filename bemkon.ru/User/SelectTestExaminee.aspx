<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectTestExaminee.aspx.cs" 
Inherits="ProfessorTesting.SelectTestExaminee" MasterPageFile="~/Main.master" %>

<%@ Register TagPrefix="uc" TagName="MenuUser" Src="~/Controls/MenuUser.ascx" %>
<%@ Register TagPrefix="uc" TagName="SelectTestExamineePanel" Src="~/Controls/SelectTestExamineePanel.ascx" %>
...
<asp:Content ID="Content9" ContentPlaceHolderID="MainContent" Runat="Server">
    <uc:SelectTestExamineePanel id="SelectTestExamineePanel1" runat="server" />
</asp:Content>
