<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopTests.aspx.cs" 
MasterPageFile="~/Main.master" Inherits="ProfessorTesting.TopTests" %>

<%@ Register TagPrefix="uc" TagName="MenuUser" Src="~/Controls/MenuUser.ascx" %>
<%@ Register TagPrefix="uc" TagName="Top10TestsPanel" Src="~/Controls/Top10TestsPanel.ascx" %>
...
<asp:Content ID="ContentHorMenuModule" ContentPlaceHolderID="HorMenuModule" Runat="Server">
    ...
    NavigateUrl="~/User/TopTests.aspx">
    Топ 10 тестов
    </asp:HyperLink>
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="MainContent" Runat="Server">
    <uc:Top10TestsPanel id="Top10TestsPanel1" runat="server" />
</asp:Content>
