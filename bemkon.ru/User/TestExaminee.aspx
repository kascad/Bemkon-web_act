<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestExaminee.aspx.cs" 
Inherits="ProfessorTesting.TestExaminee" ValidateRequest="false" MasterPageFile="~/Main.master"%>
<%@ Register TagPrefix="uc" TagName="MenuUser" Src="~/Controls/MenuUser.ascx" %>
<%@ Register TagPrefix="uc" TagName="TestingExamineePanel" Src="~/Controls/TestingExamineePanel.ascx" %>
...
<asp:Content ID="Content9" ContentPlaceHolderID="MainContent" Runat="Server">
    <uc:TestingExamineePanel id="TestingExamineePanel1" runat="server" />
</asp:Content>
