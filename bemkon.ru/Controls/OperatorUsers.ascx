<%@ Control Language="C#" AutoEventWireup="true" Inherits="Controls_OperatorUsers" ClassName="OperatorUsers"
    CodeBehind="OperatorUsers.ascx.cs" %>
...
<asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings: MyConnectionString %>"
    SelectCommand="SELECT CompanyName FROM [Company]" DeleteCommand="DELETE FROM Users WHERE [ID]=@ID">
    <DeleteParameters>
        <asp:Parameter Name="ID" Type="Int32" />
    </DeleteParameters>
</asp:SqlDataSource>
...
<div>
    <asp:GridView ID="GridView1" runat="server" Width="100%" DataSourceID="SqlDataSource2"
