...
namespace Interpret.Rules
{
    class Rule_73 : Rule
    {
        ...
        public Rule_73(string ruleTxt, StringBuilder resultSB) : base(ruleTxt, resultSB) { }
        public Rule_73(string ruleTxt, StringBuilder resultSB, Archive.Examinee examinee, int ruleID) : base(ruleTxt, resultSB, examinee, ruleID) { }
        ...
        List<Charts.percentil> s3 = new List<Charts.percentil>();
                   ...
                   // List<double> testScaleIndex2 = new List<double>();
                    ...
                    foreach (var oScale in scales)
                    {
                        ...
                        foreach (var itemScale in itemScales)
                        {
                            ...
                            int j = i + weightQuiestons.Count / 3;
                   ...
                   //List<double> testScaleIndex2 = new List<double>();
                    ...
                    foreach (var oScale in scales)
                    {
                        ...
                        foreach (var itemScale in itemScales)
                        {
                            ...
                            if (i < k)
                            {
                                WeightQuiestons itemWeight = weightQuiestons[j];
                        ...
                        for (int i = 0; i < questCount; i++)
                        {
                            ...
                            for (int counter = 0; counter < 2; counter++)
                            {
                                ...
                                else
                                {
                                    ...
                                    //System.Diagnostics.Debug.WriteLine("##############");
                                    //System.Diagnostics.Debug.WriteLine("display=(" + fstc + "+1)/" + ansCount);
                                    //System.Diagnostics.Debug.WriteLine("resultFstc= " + resultFstc);
                                    //System.Diagnostics.Debug.WriteLine("weightQuiestons" + resultFstc);
                                    //System.Diagnostics.Debug.WriteLine("weightQuiestons" + weightQuiestons.Count);
        ...
        double getBallFromOther(List<string> scn, List<double> sci, string scalename)
        {
            for (int i = 0; i < sci.Count; i++)
            {
                ...
                //   System.Diagnostics.Debug.WriteLine("sci[i]=" + sci[i]);
            }
            return 0;
        }
        void CalcAndWriteScalesSpace()
        {
            ...
            */
            ...
            for (
                int i = 0; i < OtherScaleIndex2.Count; i++)
            {
            ...
            */
            ...
            for (int i = 0; i < scn3.Count; i++)
            {
                s3.Add(new Charts.percentil(scn3[i], Math.Round(sci3[i], 2)));
            }
...
//            resultSB.Append("<p class='rule_conseq'>");
//            resultSB.Append("<table border=\"1\" width=\"700px\">");
//            resultSB.Append("<tr BGCOLOR=\"lightgray\"><th>Пространство шкал " + ScaleNameS[0] + "-" + ScaleNameS[1] + " vs " + ScaleNameS[2] + "-" + ScaleNameS[3] + " vs " + ScaleNameS[4] + "-" + ScaleNameS[5] + "</th><th>Ось" + ScaleNameS[0] + "-" + ScaleNameS[1] + "</th><th>Ось" + ScaleNameS[2] + "-" + ScaleNameS[3] + "</th><th>Ось" + ScaleNameS[4] + "-" + ScaleNameS[5] + "</th></tr>");
//            resultSB.Append("</table>");
//            resultSB.Append("</p>");
            ...
            resultSB.Append("<p class='rule_conseq'>");
            resultSB.Append("<table border=\"1\" width=\"700px\">");
            resultSB.Append("<tr BGCOLOR=\"lightgray\"><th>Пространство шкал " + ScaleNameS[4] + "-" + ScaleNameS[5] + "</th><th>Ось" + ScaleNameS[4] + "-" + ScaleNameS[5] + "</th></tr>");



            foreach (var ppp3 in s3)
            {

                resultSB.Append("<tr><td nowrap=\"nowrap\">" + ppp3.name + "</td><td >" + ppp3.value + "</td></tr>");
            }
            resultSB.Append("</table>");
            resultSB.Append("</p>");
        ...
        double getBallFromOtherScale(List<Charts.percentil> other, string scalename)
        {
            ...
            {
                //System.Diagnostics.Debug.WriteLine(i + ", " + scalename);
                //System.Diagnostics.Debug.WriteLine(i + ", " + other[i].name);
        ...
        void WriteGraphs()
        {
            ...
            List<string> hc3 = new List<string>();
            List<double> hc4 = new List<double>();
            List<double> hc5 = new List<double>();
            List<double> hc6 = new List<double>();
            List<double> hc7 = new List<double>();
            List<double> hc8 = new List<double>();
            List<double> hc9 = new List<double>();
            List<Charts.percentilxy> l11 = new List<Charts.percentilxy>();
            List<Charts.percentilxy> l12 = new List<Charts.percentilxy>();
            List<Charts.percentilxy> l13 = new List<Charts.percentilxy>();
            ...
            {
                scn3.Add(OtherScaleName3[i]);
                sci3.Add(Math.Round(OtherScaleIndex3[i], 2));
            }
            for (int i = 0; i < s1.Count; i++)
            {
                l1.Add(new Charts.percentilxyz8((s1[i].name),
                   s1[i].value,
                    getBallFromOther(scn2, sci2, s1[i].name),
                    getBallFromOther(scn3, sci3, s1[i].name)
            ));
            }
            ...
            var gr8 = new Charts.sGraph8(1024, 600, l1, 0, ScaleNameS, k2, 1);
            ...
            foreach (var item in p1)
            {
                ...
                l11.Add(new Charts.percentilxy(item.name, item.value, getBallFromOtherScale(p2, item.name)));
            }

            foreach (var item in p2)
            {

                l12.Add(new Charts.percentilxy(item.name, item.value, getBallFromOtherScale(p3, item.name)));
            }

            foreach (var item in p3)
            {
                hc3.Add(item.name);
                //l13.Add(new Charts.percentilxy(item.name, item.value, getBallFromOtherScale(p1, item.name)));
            }
            ...
            {
                hc2.Add(item2.name);
                hc5.Add(item2.valuex);
                hc7.Add(item2.valuey);
                hc9.Add(item2.valuez);
            }
            /*
            foreach (var item3 in l13)
            {
                hc3.Add(item3.name);
              //  hc8.Add(item3.valuex);
              //  hc9.Add(item3.valuey);
            }*/
            /*
            foreach (var item4 in l1)
            {
                hc4.Add(item3.valuex);
                hc5.Add(item3.valuey);
                hc6.Add(item3.valuez);
            }

            foreach (var item5 in l2)
            {
                hc7.Add(item5.valuex);
                hc8.Add(item5.valuey);
                hc9.Add(item5.valuez);
            }
            */
            ...
            // Рисуем графики highcharts

            Charts.hcGraph73 grhc = new Charts.hcGraph73(k2, hc1, hc2, scn3, hc4, hc5, hc6, hc7, hc8, hc9, uniqId, ScaleNameS, l1, l2);
            grhc.runhc(result);
            ...
            Charts.sGraph8 gr81 = new Charts.sGraph8(1024, 600, l2, 0, ScaleNameS, k2, 2);
        ...
        public override void Run()
        {
            ...
            i1 = i2 = 0;
            CalcAndWriteWeightCoeffs(ScaleNameS[4], ScaleNameS[5], ref i1, ref i2, StartIndex[4], StartIndex[5]);
